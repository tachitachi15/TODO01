...
class TaskPresenter(private val taskRepository: TaskRepository, private val view: TaskContract.View): TaskContract.Presenter {
    ...
    override fun insertTask(description: String,importance: Float) {
        val task = Task(0,0,description,importance)
    ...
    override fun updateTaskDescription(task: Task, description: String, importance: Float) {
